...
├── common.py              # Общие функции (меню, проверки)
...
- Пароли не отображаются в интерфейсе бота.
- SSH-ключи хранятся локально в папке `keys/`
